...
public class Trades {
   ...
   private String riderCode;
    ...
    private String dropOffCode;  // ST-XXXXXX generated for Post Operator dropoff
    private String directDeliveryCode; // ST-XXXXXX generated for Buyer direct delivery to Rider
